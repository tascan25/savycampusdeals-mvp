  ...
  return (
    <ScrollView contentContainerStyle={styles.content}>
      <View style={styles.intro}>
        <View>
          <AppText variant="caption" color="#A78BFA" style={styles.eyebrow}>YOUR CAMPUS REWARDS</AppText>
          <AppText variant="h1">Make every deal count.</AppText>
        </View>
        <View style={styles.introIcon}><Ionicons name="sparkles" size={20} color="#C4B5FD" /></View>
      </View>
      <TierProgressCard
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeading}>
          <View><AppText variant="h3">Ways to earn</AppText><AppText variant="caption" color={color.textTertiary}>Small actions, more campus perks.</AppText></View>
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeading}>
          <View><AppText variant="h3">Points activity</AppText><AppText variant="caption" color={color.textTertiary}>Your latest rewards, all in one place.</AppText></View>
...
const styles = StyleSheet.create({
  ...
  introIcon: { width: 44, height: 44, borderRadius: 22, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(124,58,237,0.18)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(167,139,250,0.28)" },
  copiedBanner: {
    marginTop: -space.md,
    alignItems: "center",
  },
  section: { gap: space.md, padding: space.md, borderRadius: radius.lg, backgroundColor: color.surfaceMuted, borderWidth: StyleSheet.hairlineWidth, borderColor: color.border },
